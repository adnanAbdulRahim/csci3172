...
//ACITIVTY IMPLEMENTED	
	...
	function subtract(){
		getNumbers();
		result = a - b;
		alert('The subtraction of ' + a + ' and ' + b + ' equals ' + result);
	}

	function multiply(){
		getNumbers();
		result = a * b;
		alert('The multiplication of ' + a + ' and ' + b + ' equals ' + result);
	}

	function division(){
		getNumbers();
		result = (b === 0) ? 'null' : a / b;
		alert('The division of ' + a + ' and ' + b + ' equals ' + result);
	}
